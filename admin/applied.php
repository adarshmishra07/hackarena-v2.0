        ...
        <table class="table table-striped table-bordered" style="width:100%" id="example">
                                ...
                                <?php
                                        include "../db/config.php";
                                            ...
                                            $sql="select * from data where status='pending'";
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="view.php?srno=<?php echo $srno ;?>" target="_blank"><button class="btn-table1">View</button></a>
                                            <a href="approve_move.php?srno=<?php echo $srno ;?>" ><button class="btn-table2">Approve</button></a></td>
                                    </tr>
                                    <?php 
                                                }
                                            }
